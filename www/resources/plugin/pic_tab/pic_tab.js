$.fn.banqh = function(can){
    ...
    function show(tpqhnum){
        ...
        if($('.small-mask').length>0){
            $(can.pnum).find('li').eq(tpqhnum).addClass("on").find('.small-mask').css('display','none').parents('li').siblings(this).removeClass("on").find('.small-mask').css('display','block');
        }else{
