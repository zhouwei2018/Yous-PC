...
var INFOBOX_AT_TOP= window.INFOBOX_AT_TOP = 1, INFOBOX_AT_RIGHT= window.INFOBOX_AT_RIGHT = 2, INFOBOX_AT_BOTTOM= window.INFOBOX_AT_BOTTOM = 3, INFOBOX_AT_LEFT= window.INFOBOX_AT_LEFT = 4;
(function() {
    //澹版槑baidu鍖�
    ...
    var InfoBox =
        ...
        BMapLib.InfoBox = function(map, content, opts) {
            ...
            this._opts.closeIconClass = opts.closeIconClass || '';
    ...
    InfoBox.prototype.getOffset = function(){
        ...
        baidu.object.extend(InfoBox.prototype,{
            ...
            _getCloseIcon: function(){
                var img = "<img  src='"+ this._opts.closeIconUrl +"' align='right' style='width:16px;height:16px;position:absolute;right:0;cursor:pointer;margin:"+ this._opts.closeIconMargin +"'/>";
                return img;
            },
            /**
             * 璁剧疆infoBox鐨勫唴瀹�
            ...
            _panBox: function(){
                ...
                var panX = window.panX = panLeft > 0 ? panLeft : (panRight > 0 ? -panRight : 0);
