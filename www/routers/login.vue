                    ...
                    <div class="content_wrap login fr">
                        <div class="login_bg">
                            ...
                            <Form ref="formInline" :model="formInline" :rules="ruleInline">
                                <Form-item prop="user">
                                    <Input value="" style="width: 100%" type="text" v-model="formInline.user"
                                           placeholder="请输入手机号码" size="large"></Input>
                                </Form-item>

                                <Form-item prop="password">
                                    <Input value="" style="width: 100%" type="password" placeholder="请输入密码"
                                           v-model="formInline.password" size="large"></Input>
                                </Form-item>

                                <Form-item>
                                    <Button size="large" class="next  btnSubmit" :loading="loading" type="primary"
